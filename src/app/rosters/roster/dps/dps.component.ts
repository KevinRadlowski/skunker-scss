...
const ELEMENT_DATA: PeriodicElement[] = [
  {
    ...
    chasseur: { nom: 'Buddhacheese', url: '', grade: '' },
    mage: { nom: 'Dudull', url: '', grade: '' },
    guerrier: { nom: 'Couryvit', url: '', grade: '' },
  ...
  },
  {
    ...
    chaman: { nom: 'Livesergent (reroll)', url: '', grade: '' }
  },
  {
    position: 4,
    voleur: { nom: 'Beez', url: '', grade: '' },
    demoniste: { nom: 'Hayzen', url: '', grade: '' },
  ...
  },
  {
    ...
    guerrier: { nom: 'Øzii', url: '', grade: 'assets/img/skunk-green.png' },
    chaman: { nom: '', url: '', grade: '' }
  },
  {
    position: 7,
    ...
    chasseur: { nom: 'Scritch', url: '', grade: '' },
  ...
  },
  {
    ...
    mage: { nom: 'Traficdecèss (reroll)', url: '', grade: '' },
    guerrier: { nom: '', url: '', grade: '' },
    chaman: { nom: '', url: '', grade: '' }
  },
  {
    position: 10,
    voleur: { nom: 'Serialkiller', url: '', grade: '' },
  ...
  },
  {
    ...
    demoniste: { nom: 'Orgrik', url: '', grade: '' },
  ...
  },
  {
    ...
    demoniste: { nom: 'Sethre', url: '', grade: '' },
    chasseur: { nom: '', url: '', grade: '' },
    mage: { nom: '', url: '', grade: '' },
    guerrier: { nom: '', url: '', grade: '' },
    chaman: { nom: '', url: '', grade: '' }
